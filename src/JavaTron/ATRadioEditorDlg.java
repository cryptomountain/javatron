...
public class ATRadioEditorDlg extends javax.swing.JFrame {
    ...
    public ATRadioEditorDlg(AudioTronState at_,
	...
	public ATRadioEditorDlg(AudioTronState at_,
							...
							String label_,
							JToggleButton toggle,
							ArrayList<StationEntry> stationList_){
		super(label_);
		//super(parent, label_, toggle);
		at=at_;
    ...
    private void initComponents() {
        ...
        jVerifyButton = new javax.swing.JButton();
        ...
        rtPopup.setName("rtPopup"); // NOI18N

        poptop.setText("jMenu4");
        poptop.setName("poptop"); // NOI18N
        ...
        radioTable.setName("radioTable"); // NOI18N
        ...
        saveButtonBar.setName("saveButtonBar"); // NOI18N
        ...
        installButtonBar.setName("installButtonBar"); // NOI18N
        ...
        jUpButton.setName("jUpButton"); // NOI18N
        ...
        jDownButton.setName("jDownButton"); // NOI18N
        ...
        deleteButtonBar.setName("deleteButtonBar"); // NOI18N
        ...
        jVerifyButton.setFocusable(false);
        jVerifyButton.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        jVerifyButton.setName("jVerifyButton"); // NOI18N
        jVerifyButton.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        jVerifyButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jVerifyButtonActionPerformed(evt);
            }
        });
        jToolBar1.add(jVerifyButton);

        jLabel1.setText("Stations:");
        jLabel1.setName("jLabel1"); // NOI18N

        stationCounter.setText("215");
        stationCounter.setName("stationCounter"); // NOI18N

        rptText.setText("jLabel2");
        rptText.setName("rptText"); // NOI18N
        ...
        mInstall.setName("mInstall"); // NOI18N
        ...
        mImportCSV.setName("mImportCSV"); // NOI18N
        ...
        mExportCSV.setName("mExportCSV"); // NOI18N
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addComponent(stationCounter, javax.swing.GroupLayout.PREFERRED_SIZE, 57, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(40, 40, 40)
                        .addComponent(rptText, javax.swing.GroupLayout.PREFERRED_SIZE, 83, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(jLabel1)
                        .addComponent(stationCounter)
                        .addComponent(rptText))
                    ...
                    .addComponent(replaceButton, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
	...
	private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
		...
		for(int i=rows-2;i > -1;i--){
			if(showExtra){System.out.println("i="+i+", value="+radioTable.getValueAt(i, 0));}
			try{
				if(radioTable.getValueAt(i,0).equals(Boolean.TRUE))
					rtm.removeRow(i);
			}catch(Exception e){
				//Do nothing
			}
	...
	private void installButtonBarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_installButtonBarActionPerformed
		install();
	}//GEN-LAST:event_installButtonBarActionPerformed

	private void saveButtonBarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonBarActionPerformed
	...
	}//GEN-LAST:event_saveButtonBarActionPerformed
	...
	private void mNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mNewActionPerformed
		int res=JOptionPane.showConfirmDialog(this, "This will clear the list and you will lose any changes. Are you sure you want to?",
	...
	private void deleteButtonBarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonBarActionPerformed
		deleteButtonActionPerformed(evt);
	}//GEN-LAST:event_deleteButtonBarActionPerformed
	...
	private void jDownButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jDownButtonActionPerformed
		...
		int start=selrow[0];
		int end=start + selrow.length - 1;//int end=selrow[ start + selrow.length ];
	...
	private void radioTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_radioTableMouseClicked
		
	}//GEN-LAST:event_radioTableMouseClicked

	private void radioTableMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_radioTableMousePressed
//		JPop j=new JPop("Bing!","Tickle Elmo!");
//		System.out.println(evt.paramString());
//		if(evt.isPopupTrigger()){
//			j=new JPop("Boing!","pressed");
//			rtPopup.show(radioTable,100,100);
//		}
		//JPop j=new JPop("Boing!","pressed");
	}//GEN-LAST:event_radioTableMousePressed
	...
	private void importButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_importButtonActionPerformed
		...
		if(csvfile==null){
				//new JPop("Action Cancelled","Aborted");
				return;
		}
	...
	private void mInstallActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mInstallActionPerformed
		replaceButtonActionPerformed(evt);
}//GEN-LAST:event_mInstallActionPerformed
	...
	private void jVerifyButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jVerifyButtonActionPerformed
		// TODO add your handling code here:
		int[] selrow = radioTable.getSelectedRows();
		int start = selrow[0];
		int end=start + selrow.length -1;
		
	}//GEN-LAST:event_jVerifyButtonActionPerformed
	...
	private void install(){
		class writeRadio extends Thread{
			public void run(){
				...
				//System.out.println("red.radioURL : "+ radioURL);
				setRadioURL();
				...
				if(rf.getHost().isEmpty() || rf.getPassword().isEmpty() ||
					rf.getUsername().isEmpty() )
				{
					JPop j=new JPop("Not enough Information","Network Resrouces Incomplete\r\nPlease Check the Radio section in Preferences");
					return;
				}
				...
				for(int i=0;i<rows-1;i++){
					if(showExtra){System.out.print(i+"...");}
					StationEntry se=new StationEntry(radioTable.getValueAt(i, 3).toString(),
										radioTable.getValueAt(i, 1).toString(),
										radioTable.getValueAt(i,2).toString(),
										radioTable.getValueAt(i,4).toString(),
										v );
					se.Validate();
					if(showExtra){System.out.println(se.toString());}
					rf.addStation(se);
				}
	...
	public void setRadioURL(){
		String ru="smb://"+Configuration.getProperty(Configuration.KEY_RADIO_HOST)+"/" +
				Configuration.getProperty(Configuration.KEY_RADIO_SHARE)+"/"+
				"radio.txt";
		setRadioURL(ru);
	}
	...
	private class RadioTableModel extends DefaultTableModel{
		...
		public RadioTableModel(){
			super( new Object [][] {new Object[]{Boolean.FALSE,null,null,null,null,Boolean.TRUE}},
				   new String [] {"Select", "Title", "Location", "Category", "Format", "Valid"});
	...
	public class RadioTableListener implements TableModelListener {
		...
		public void tableChanged(TableModelEvent e) {
			if(showExtra){System.out.println("Table Changed...");}
    ...
    private javax.swing.JButton jVerifyButton;
